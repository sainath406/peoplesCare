...
<div id="makeapp"> 
    <a href="#">
        <button class="makeappoin">Ask your Question</button>
    </a> 
    <a href="#">
        <button class="makeappoin">Camp Request</button>
    </a> 
    <a href="#">
        <button class="makeappoin">Dental insurance</button>
    </a> 
    <a href="#">
        <button class="makeappoin">Careers</button>
    </a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="foot-item">
                    <!-- Heading -->
                    <h5 class="bold"><i class="fas fa-link"></i> Our Links</h5>
                    <!-- Foot Item Content -->
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="foot-item">
                    <!-- Heading -->
                    <h5 class="bold"><i class="fas fa-stethoscope"></i> Treatments</h5>
                    <!-- Foot Item Content -->
                    <div class="foot-item-content">
                        <ul class="list-unstyled">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="foot-item">
                    <!-- Heading -->
                    <h5 class="bold"><i class="fas fa-building"></i>&nbsp;&nbsp;Contact Us</h5>
                    <!-- Foot Item Content -->
                    <div class="foot-item-content address">
                        <!-- Heading -->
                        <!-- Paragraph -->
                        <p class="tel"><i class="fas fa-address-card"></i>&nbsp;16-2-MIG/18, Opp: Rainbow Hospital, Above HDFC Bank, 2nd Floor, Beside Hydernagar Bus Stop, Kukatpally, Hyderabad. </p>
                        <p class="tel"><i class="fas fa-phone"></i> Ph : 040-42210100, 8143011112<br />
                            <i class="fas fa-envelope"></i> Mail : <a href="#">info@peoplesdentalcare.in</a><br />
                        </p>
                    </div>
                </div>
            </div>
...
<!-- Javascript files -->
<script src="<?= config_item('root_dir') ?>assets/js/jquery.js"></script>
<script src="<?= config_item('root_dir') ?>assets/js/bootstrap.min.js"></script>
<script src="<?= config_item('root_dir') ?>assets/js/placeholders.js"></script>
<script src="<?= config_item('root_dir') ?>assets/js/jquery.magnific-popup.min.js"></script>
<script src="<?= config_item('root_dir') ?>assets/js/owl.carousel.min.js"></script>
